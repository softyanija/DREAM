...
image_topic = "/timer_cam1/timer_cam_image/image_rect_color"

# ROS topic for listening to camera intrinsics
camera_info_topic = "/timer_cam1/timer_cam_image/camera_info"
...
tform_out_childname = "/timer_cam1/timer_cam_image/timer_cam1_frame"
...
class DreamInferenceROS:
    def __init__(self, args, single_frame_mode=True, compute_2d_to_3d_transform=False):
        ...
        self.camera_pose_tform.child_frame_id = 'timer_cam1_optical_frame'
